#srun --partition=nvgpu --nodes=1 --ntasks=1 --gres=gpu:1 --mem=32G --cpus-per-task=16 --time=01-23:59:59 --pty /bin/bash
#module load cuda/12.2.2
#python3 run.py --model_type "custom" --pdb_path "./inputs/control/Control_2.pdb" --out_folder "./outputs/control/Run_2" --pack_side_chains 1 --number_of_packs_per_design 1 --number_of_batches 50 --pack_with_ligand_context 1 --ligand_mpnn_use_atom_context 1 --fixed_residues "B4 B5 B6 B7 B8 B9"--repack_everything 1
#python3 run.py --model_type "ligand_mpnn" --pdb_path "./inputs/control/Control_2.pdb" --out_folder "./outputs/control/Run_2" --pack_side_chains 1 --number_of_packs_per_design 1 --number_of_batches 50 --pack_with_ligand_context 1 --ligand_mpnn_use_atom_context 1 --fixed_residues "B4 B5 B6 B7 B8 B9" --repack_everything 1 --checkpoint_ligand_mpnn ""/gpfs1/home/j/j/jjung2/scratch/ARProtein-project/LigandMPNN/my_model_weights/checkpoint_epoch_1.p"
#python3 run.py --model_type "ligand_mpnn" --temperature 0.10 --pdb_path "./inputs/shorter_ligands/darpin_4.pdb" --out_folder "./outputs/shorter_ligands/Run_22" --pack_side_chains 1  --number_of_packs_per_design 1 --number_of_batches 50 --pack_with_ligand_context 1 --ligand_mpnn_use_atom_context 1 --fixed_residues "B6 B7 B8 B9 B10 B11 B12 B13 B14" --repack_everything 1 --checkpoint_ligand_mpnn "/gpfs1/home/j/j/jjung2/scratch/ARProtein-project/LigandMPNN/training_output/checkpoint_epoch_14.pt"
...
def main(args) -> None:
    ...
    if args.model_type == "protein_mpnn":
        ...
        checkpoint_path = "/gpfs1/home/j/j/jjung2/scratch/ARProtein-project/LigandMPNN/my_model_weights/checkpoint_epoch_9.pt"
